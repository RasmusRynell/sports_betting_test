...
raw_data_1 = pd.read_csv("./Datasets/2013-14.csv")
raw_data_2 = pd.read_csv("./Datasets/2014-15.csv")
raw_data_3 = pd.read_csv("./Datasets/2015-16.csv")
raw_data_1 = raw_data_1[raw_data_1.columns[:23]]
raw_data_2 = raw_data_2[raw_data_2.columns[:23]]
raw_data_3 = raw_data_3[raw_data_3.columns[:23]]

#Gets all the statistics related to gameplay
                      
columns_req = ['Date','HomeTeam','AwayTeam','FTHG','FTAG','FTR', "HTHG", "HTAG", "HTR", "HS", "AS", "HST", "HF", "AF", "HC", "AC", "HY", "AY", "HR", "AR"]
...
playing_stat = pd.concat([playing_statistics_1, playing_statistics_2, playing_statistics_3], ignore_index=True)
